...
type ConfChange struct {
	...
	// When applying the conf change, campaign the given node ID, skipping
	// prevote. Primarily used when the leader removes itself, to designate an
	// up-to-date follower that will assume leadership.
	CampaignNodeID uint64 `protobuf:"varint,5,opt,name=campaign_node_id,json=campaignNodeId" json:"campaign_node_id"`
...
type ConfChangeV2 struct {
	...
	// prevote. Primarily used when the leader removes itself, to designate an
	// up-to-date follower that will assume leadership.
	CampaignNodeID uint64 `protobuf:"varint,4,opt,name=campaign_node_id,json=campaignNodeId" json:"campaign_node_id"`
}
...
var fileDescriptor_b042552c306ae59b = []byte{
	...
	,
}
...
func (m *ConfChange) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	i = encodeVarintRaft(dAtA, i, uint64(m.CampaignNodeID))
	i--
	dAtA[i] = 0x28
	if m.Context != nil {
		i -= len(m.Context)
...
func (m *ConfChange) Size() (n int) {
	...
	n += 1 + sovRaft(uint64(m.CampaignNodeID))
	return n
}
...
func (m *ConfChange) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field CampaignNodeID", wireType)
			}
			m.CampaignNodeID = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.CampaignNodeID |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
